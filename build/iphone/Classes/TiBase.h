...
// in simulator we redefine to format for PlatinoStarterKit Developer console
...
{\
	NSString * exceptionName = [@"org.platinostarterkit." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.platinostarterkit";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPlatinoStarterKitNativeItemNone = -1, 
	UIPlatinoStarterKitNativeItemSpinner = -2,
	UIPlatinoStarterKitNativeItemProgressBar = -3,
	
	UIPlatinoStarterKitNativeItemSlider = -4,
	UIPlatinoStarterKitNativeItemSwitch = -5,
	UIPlatinoStarterKitNativeItemMultiButton = -6,
	UIPlatinoStarterKitNativeItemSegmented = -7,
	
	UIPlatinoStarterKitNativeItemTextView = -8,
	UIPlatinoStarterKitNativeItemTextField = -9,
	UIPlatinoStarterKitNativeItemSearchBar = -10,
	
	UIPlatinoStarterKitNativeItemPicker = -11,
	UIPlatinoStarterKitNativeItemDatePicker = -12,
	
	UIPlatinoStarterKitNativeItemInfoLight = -13,
	UIPlatinoStarterKitNativeItemInfoDark = -14,
	
	UIPlatinoStarterKitNativeItemDisclosure = -15,
	
	UIPlatinoStarterKitNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PlatinoStarterKit instances of
