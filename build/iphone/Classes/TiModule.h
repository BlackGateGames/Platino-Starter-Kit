...
/**
 The base class for all PlatinoStarterKit modules
 */
...
/**
 PlatinoStarterKit Platform calls this method on startup.
 */
-(void)startup;

/**
 PlatinoStarterKit Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PlatinoStarterKit Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PlatinoStarterKit Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PlatinoStarterKit Platform calls this method on resume.
 @param sender The sender of the event.
 */
