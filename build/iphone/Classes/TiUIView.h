...
/**
 Base class for all PlatinoStarterKit views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PlatinoStarterKit view hierarchy (such as wrapped iOS UIViews) was touched.
