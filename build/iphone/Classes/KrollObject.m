...
//@interface PlatinoStarterKitObject : NSObject
//@end

@interface PlatinoStarterKitObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PlatinoStarterKitObject class]])
		{
			for (NSString *key in [[(PlatinoStarterKitObject*)o modules] allKeys])
			{
