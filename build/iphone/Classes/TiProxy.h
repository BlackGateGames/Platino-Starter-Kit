...
//Rare exceptions to indicate a bug in the _platinostarterkit code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PlatinoStarterKit proxies.
 */
