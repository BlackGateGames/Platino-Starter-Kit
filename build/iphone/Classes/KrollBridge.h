...
@interface PlatinoStarterKitObject : KrollCoverageObject {
#else
@interface PlatinoStarterKitObject : KrollObject {
#endif
@private
...
extern NSString * PlatinoStarterKit$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PlatinoStarterKitObject *_platinostarterkit;
    KrollObject* console;
	BOOL shutdown;
