 ...
 * to send analytic data that can be viewed on the PlatinoStarterKit Dashboard.
 *
 * For information on getting started with PlatinoStarterKit Platform Services,
